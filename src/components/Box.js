...
const Box = (props)=>{
    const pics = [partlycloudy, snow, rain, mist ,thunder, sunny, cloudy, haze, snow, cloudy, snow]
    const sources = ['partly cloudy', 'snow', 'rain', 'mist' ,'thunder', 'sunny', 'cloudy', 'haze', 'sleet', 'overcast', 'blizzard']
